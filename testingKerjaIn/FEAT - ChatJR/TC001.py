...
class DemoFindElementByIDandName():
    def locate_by_ID_demo(self):
        ...
        try:
            ...
            wait.until(EC.element_to_be_clickable((By.XPATH, "//a[@class='nav-link '][normalize-space()='Pesan']"))).click()
            find_scroll_and_click((By.XPATH, "//body[1]/main[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/a[1]"))
            find_scroll_and_click((By.XPATH, "//div[@class='chat-item-card rounded-5 ']"))
            find_scroll_and_send_keys((By.XPATH, "//input[@placeholder='Tulis pesan...']"), 'Hello')
            find_scroll_and_click((By.XPATH, "//button[@class='btn btn-send-circle ms-2 rounded-circle']"))
