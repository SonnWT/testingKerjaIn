...
class DemoFindElementByIDandName():
    def locate_by_ID_demo(self):
        ...
        try:
            ...
            find_scroll_and_click((By.XPATH, "//a[@id='dropdownProfile']"))
            ...
            find_scroll_and_send_keys((By.ID, 'tanggal_lahir'), '22/07/2008')
            find_scroll_and_select_dropdown((By.ID, 'jenis_kelamin'), 'Male')
            find_scroll_and_send_keys((By.ID, 'nomor_telepon'), '081234567890')
            find_scroll_and_send_keys((By.ID, 'nomor_ktp'), '12345678901234567')
