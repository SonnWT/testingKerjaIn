...
class DemoFindElementByIDandName():
    def locate_by_ID_demo(self):
        ...
        try:
            ...
            time.sleep(0.5)
            wait.until(EC.element_to_be_clickable((By.XPATH, "//button[@class='dropdown-item d-flex align-items-center gap-1']"))).click()
            time.sleep(0.5)
            ...
            find_scroll_and_click((By.XPATH, "//a[normalize-space()='Become a Partner']"))
            ...
            find_scroll_and_send_keys((By.ID, 'selfie_photo'), 'C://Users//agust//Downloads//foto_diri.jpg')
            find_scroll_and_send_keys((By.ID, 'id_card_photo'), 'C://Users//agust//Downloads//foto_ktp.jpg')
            find_scroll_and_send_keys((By.ID, 'selfie_with_id_card_photo'), 'C://Users//agust//Downloads//foto_diri_ktp.jpg')
            ...
            time.sleep(5)
            find_scroll_and_click((By.XPATH, "//a[normalize-space()='Kembali ke Beranda']"))
            wait.until(EC.element_to_be_clickable((By.ID, 'dropdownProfile'))).click()
