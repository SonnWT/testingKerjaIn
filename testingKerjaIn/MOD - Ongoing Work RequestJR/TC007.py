...
class DemoFindElementByIDandName():
    def locate_by_ID_demo(self):
        ...
        try:
            ...
            find_scroll_and_click((By.XPATH, "//body/main[@class='main-content']/div[@class='container-fluid pembatas-x pembatas-b d-flex flex-column gap-4']/div[@class='d-flex']/div[@class='col-12 col-xl-8 d-flex flex-column gap-4 beranda-req-kiri']/div[4]"))
            find_scroll_and_click((By.ID, "completeJobBtn"))
            find_scroll_and_click((By.XPATH, "//button[@class='btn py-3 fw-semibold rounded-4']"))
